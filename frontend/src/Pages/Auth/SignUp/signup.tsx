...
import { Eye, EyeOff, MessageCircle, User, Mail, Lock, Phone, ArrowRight, Sparkles } from 'lucide-react';
          ...
          <div className="backdrop-blur-2xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-8 transition-all duration-300 hover:bg-white/15">
            ...
            <div className="space-y-6">
              ...
              <div className="group">
                ...
                <div className="group">
                  <div className="relative">
                    <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/50 h-5 w-5 group-focus-within:text-purple-300 transition-colors" />
                    <input
                      type="tel"
                      name="phone"
              ...
              <div className="group">
                ...
                <div className="text-right">
                  <a href="#" className="text-purple-300 hover:text-purple-200 transition-colors text-sm">
                    Forgot Password? 🔑
                  </a>
                </div>
            ...
            <div className="mt-8 text-center">
              ...
              <button
                className="text-purple-300 hover:text-white font-semibold transition-all hover:underline decoration-2 underline-offset-2"
              >
                Sign Up 
              </button>
            </div>
